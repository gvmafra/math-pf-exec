...
export const challenges: challengeDetailsMap = {
  ...
  Circle6c: {
    ...
    numCells: 6,
    paths: [
      'M71.5,12.8C50.9,.9,24.6,8,12.7,28.6l74.5,43c11.9-20.6,4.9-46.9-15.7-58.8h0Z',
      'M87.2,28.6l-37.2,21.4,37.2,21.5c7.7-13.3,7.7-29.7,0-42.9h0Z',
      'M50,7.1V50L12.7,28.6C20.4,15.3,34.6,7.1,50,7.1h0Z',
      'M87.2,28.5l-37.2,21.5V7c15.4,0,29.5,8.2,37.2,21.5h0Z',
      'M28.5,87.2C7.9,75.4,.9,49.1,12.8,28.5l74.5,43c-11.9,20.6-38.2,27.6-58.7,15.8h0Z',
      'M50,92.9V50l37.3,21.5c-7.7,13.3-21.9,21.4-37.3,21.4h0Z',
      'M12.8,71.5l37.2-21.4L12.8,28.5c-7.7,13.3-7.7,29.6,0,42.9h0Z',
      'M50,92.9V50c0,0-37.2,21.5-37.2,21.5,7.7,13.3,21.9,21.4,37.2,21.4h0Z',
    ],
  },
  Circle6g: {
    shape: 'circle',
  ...
  Diamond8e: {
    ...
    paths: [
      ...
      'M71.5,71.5v-43L50,50L71.5,71.5z',
      'M71.5,71.5v-43L93,50L71.5,71.5z',
      'M28.5,71.5v-43L7,50L28.5,71.5z',
      'M28.5,71.5v-43L50,50L28.5,71.5z',
    ],
  },
  Diamond8f: {
    shape: 'diamond',
    ...
    paths: [
      ...
      'M28.5,28.8v42.8l21.5-21.4L28.5,28.8L28.5,28.8z',
