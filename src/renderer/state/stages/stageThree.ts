...
const genStageThree = (): Stage => ({
  levels: initializeLevels(
    ...
    [
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 2, columns: 1 }),
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 2, columns: 1 }),
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 1, columns: 2 }),
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 1, columns: 2 }),
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 2, columns: 2 }),
      genGridCanvas({ rows: 2, columns: 1 }, { rows: 2, columns: 2 }),
      genGridCanvas({ rows: 1, columns: 2 }, { rows: 2, columns: 2 }),
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 2, columns: 2 }),
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 2, columns: 1 }),
      genGridCanvas({ rows: 1, columns: 1 }, { rows: 2, columns: 1 }),
    ]
